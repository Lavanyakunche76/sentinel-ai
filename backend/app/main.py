...
from app.models.orm import Agent, Policy, User
from app.core.security import hash_password
from app.routers import agents, firewall, audit, approvals, policies, auth
    ...
    try:
        if db.query(User).count() == 0:
            db.add(User(
                ...
                name="Lavanya Kunche",
                hashed_password=hash_password("SentinelDemo123!"),
                role="admin",
            ))
